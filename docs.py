index = """
    ...
    Причина - официальная версия не работает долгое время (на момент написания этого текста (06.10.2021) всё ещё не работает).<br>
    Сервер написан на python с нуля. Клиентская часть никак не изменена (кроме исправления нескольких багов).<br>
    Официальная версия будет доступна только в конце ноября (18.12.2021 - всё ещё жду).<br><br>
    ...
    Разработчики офиц. версии (twitch):<br>
     ...
     Предположения о новой версии бм (официальной, которая выйдет в конце ноября):<br>
     Будет переработан интерфейс.<br>
     Будет переработана система дуелей.<br>
     Возможно будет переработана система уровней.<br>
     Возможно будет переход на вебсокеты.<br>
     Возможно будет улучшена защита.<br>
     <br>
